...
// #define PTE_COW_MASK 0xFFC0000000000000L
// #define PTE_COW_NUM(pte) ((((pte)&PTE_COW_MASK) >> 54) & 0x3FF)
// #define PTE_COW_SET_NUM(pte, num)
//   do
//   {
//     uint64 n = num;
//     n <<= 54;
...
//     pte &= n;
//   } while (0)
// #define PTE_INCR_COW_NUM(pte)
//   do
//   {
//     uint64 num = PTE_COW_NUM(pte) + 1;
//     PTE_COW_SET_NUM(pte, num);
//   } while (0)
// #define PTE_DECR_COW_NUM(pte)
//   do
//   {
//     uint64 num = PTE_COW_NUM(pte) - 1;
//     PTE_COW_SET_NUM(pte, num);
